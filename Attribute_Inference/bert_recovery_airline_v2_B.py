...
plt.savefig('white_salad_5_layer_1class_test_data_list_epoch.png')
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('white_salad_5_layer_1class_training_data_list_epoch.png')
...
plt.xlabel("label")
plt.ylabel("freq")
plt.title("white_salad_5_layer_1class_test_data_list_sample")
plt.savefig('white_salad_5_layer_1class_test_data_list_sample.png')

plt.hist(training_data_list_sample, range=(0,1))
plt.xlabel("label")
plt.ylabel("freq")
plt.title("white_salad_5_layer_1class_training_data_list_sample")
plt.savefig('white_salad_5_layer_1class_training_data_list_sample.png')
