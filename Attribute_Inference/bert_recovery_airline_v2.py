...
plt.savefig('5_layer_1class_test_data_list_epoch.png')
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('5_layer_1class_training_data_list_epoch.png')
...
plt.hist(test_data_list_sample, bins=10, normed=0, facecolor="blue", edgecolor="black", alpha=0.7)
plt.xlabel("label")
plt.ylabel("freq")
plt.title("5_layer_1class_test_data_list_sample")
plt.savefig('5_layer_1class_test_data_list_sample.png')

plt.hist(training_data_list_sample, bins=10, normed=0, facecolor="blue", edgecolor="black", alpha=0.7)
plt.xlabel("label")
plt.ylabel("freq")
plt.title("5_layer_1class_training_data_list_sample")
plt.savefig('5_layer_1class_training_data_list_sample.png')
