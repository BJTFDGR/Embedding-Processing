...
print(labels[0:100])
print(pd.value_counts(labels.numpy()))
...
weight_CE = torch.FloatTensor([1, 1.11085])
...
plt.savefig('Binary_3_layer_top_1_test_data_list_epoch.png')
plt.close()
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('Binary_3_layer_top_1_training_data_list_epoch.png')
plt.close()
...
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("Binary_3_layer_top_1_test_data_list_sample")
plt.savefig('Binary_3_layer_top_1_test_data_list_sample.png')
plt.close()
plt.hist(training_data_list_sample, range=(0, 1))
plt.xlabel("label")
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("Binary_3_layer_top_1_training_data_list_sample")
plt.savefig('Binary_3_layer_top_1_training_data_list_sample.png')
plt.close()
print(len(training_data_list_sample))
print(len(test_data_list_sample))
print(sum(i > 0.7 for i in training_data_list_sample))
print(sum(i > 0.7 for i in test_data_list_sample))  # 7000 16250 28 77
...
plt.savefig('F02_Binary_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_Binary_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F02_Binary_3_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_Binary_3_layer_top_1_test_data_list_sample.png')
plt.close()
