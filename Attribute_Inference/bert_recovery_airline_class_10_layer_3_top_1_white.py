...
plt.savefig('3_layer_top_1_test_data_list_epoch.png')
plt.close()
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('3_layer_top_1_training_data_list_epoch.png')
plt.close()
...
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("3_layer_top_1_test_data_list_sample")
plt.savefig('3_layer_top_1_test_data_list_sample.png')
plt.close()
plt.hist(training_data_list_sample, range=(0,1))
plt.xlabel("label")
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("3_layer_top_1_training_data_list_sample")
plt.savefig('3_layer_top_1_training_data_list_sample.png')
plt.close()
print(len(training_data_list_sample))
print(len(test_data_list_sample))
print(sum(i >0.4 for i in training_data_list_sample))
print(sum(i >0.4 for i in test_data_list_sample))# 13750 32000 0 0
...
plt.savefig('F02_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0.2, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.2)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F02_3_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.xlim(0.2, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_3_layer_top_1_test_data_list_sample.png')
plt.close()
