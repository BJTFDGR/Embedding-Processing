...
weight_CE = torch.FloatTensor([1, 1.075])
...
plt.savefig('onlySaladBinary_3_layer_top_1_test_data_list_epoch.png')
plt.close()
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('onlySaladBinary_3_layer_top_1_training_data_list_epoch.png')
plt.close()
...
plt.savefig('onlySaladBinary_3_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.savefig('onlySaladBinary_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('onlySaladF02_Binary_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('onlySaladF28_Binary_3_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('onlySaladF02_Binary_3_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('onlySalad_F28_Binary_3_layer_top_1_test_data_list_sample.png')
plt.close()
