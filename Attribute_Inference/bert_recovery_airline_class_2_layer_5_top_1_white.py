'''
 in training_data_list_sample:
    if i>0.2:k1.append(i)
    else: k2.append(i)
7000 16250 15 99
'''
...
plt.savefig('Binary_5_layer_top_1_test_data_list_epoch.png')
plt.close()
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('Binary_5_layer_top_1_training_data_list_epoch.png')
plt.close()
...
plt.savefig('Binary_5_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.savefig('Binary_5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F02_Binary_5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_Binary_5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F02_Binary_5_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_5_layer_top_1_test_data_list_sample")
plt.savefig('F28_Binary_5_layer_top_1_test_data_list_sample.png')
plt.close()
