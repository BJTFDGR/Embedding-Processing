...
def get_embedding(input_vector,i):
    ...
    for input_text in input_vector:
        ...
        #   story = torch.Tensor(tokenizer.encode(input_text, add_special_tokens=True, padding= 'max_length',max_length = 32 )).long() 
...
class MLP(torch.nn.Module):
    def __init__(self):
        ...
        self.fc2 = torch.nn.Linear(200,int(max(label)+1))
...
def AccuarcyComputeT3(pred,label):
    with torch.no_grad():
        ...
        label = label.cpu().data.numpy()
        count=0
        values, indices = torch.tensor(pred).topk(5, dim=1, largest=True, sorted=True)
...
plt.savefig('Binary_ReocverYear5_layer_top_1_test_data_list_epoch.png')
plt.close()
plt.plot(range(len(training_data_list_epoch)), training_data_list_epoch)
plt.savefig('Binary_ReocverYear5_layer_top_1_training_data_list_epoch.png')
plt.close()
...
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("Binary_ReocverYear5_layer_top_1_test_data_list_sample")
plt.savefig('Binary_ReocverYear5_layer_top_1_test_data_list_sample.png')
plt.close()
plt.hist(training_data_list_sample, range=(0,1))
plt.xlabel("label")
plt.ylabel("freq")
plt.xlim(0, 1)
plt.title("Binary_ReocverYear5_layer_top_3_training_data_list_sample")
plt.savefig('Binary_ReocverYear5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.ylabel("freq")
plt.xlim(0, 0.6)
plt.title("Binary_ReocverYear_5_layer_top_1_test_data_list_sample")
plt.savefig('Binary_ReocverYearF02_5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_ReocverYear_5_layer_top_1_test_data_list_sample")
plt.savefig('Binary_ReocverYearF28_5_layer_top_1_training_data_list_sample.png')
plt.close()
...
plt.xlim(0, 0.6)
plt.title("Binary_ReocverYear_5_layer_top_1_test_data_list_sample")
plt.savefig('Binary_ReocverYearF02_5_layer_top_1_test_data_list_sample.png')
plt.close()
...
plt.xlim(0.6, 0.9)
plt.title("Binary_ReocverYear_5_layer_top_1_test_data_list_sample")
plt.savefig('Binary_ReocverYearF28_5_layer_top_1_test_data_list_sample.png')
plt.close()
